...
public class WorkflowEngineImpl implements WorkflowEngine {
	...
	public TaskReport run(Workflow workFlow, WorkflowContext workflowContext) throws WorkflowException {
		logger.log(Level.INFO, "Running Workflow ", workFlow.getName());
		return workFlow.execute(workflowContext);
	}
}
