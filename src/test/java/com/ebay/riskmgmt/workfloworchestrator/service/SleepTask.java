...
public class SleepTask extends AbstractTask {
	...
	private static Logger logger = Logger.getLogger("SleepTask");
	...
	public TaskReport execute(WorkflowContext workflowContext) {
		try {
			//logger.log(LogLevel.INFO, "Sleeping for "+duration+" ms.");
			Thread.sleep(duration);
			//logger.log(LogLevel.INFO, "Sleep over, awake now.");
		} catch (Exception e) {
			//logger.log(Level.ERROR, "Unable to complete task", e);
